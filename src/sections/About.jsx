    ...
    <section className="c-space section-spacing" id="about">
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-6 md:auto-rows-[22rem] mt-12">
        ...
        <Reveal delay={0.1} className="grid-1">
          <div className="flex flex-col justify-between grid-default-color h-full w-full">
        ...
        <Reveal delay={0.2} className="grid-2">
          <div className="grid-default-color h-full w-full">
            <div
              ref={grid2Container}
        ...
        <Reveal delay={0.3} className="grid-3">
          <div className="grid-black-color h-full w-full">
        ...
        <Reveal delay={0.4} className="grid-4">
          <div className="grid-special-color h-full w-full">
